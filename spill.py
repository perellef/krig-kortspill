...
class Spill:
    ...
    def __init__(self,ant_spillere,spilleforer):        
        ...
        for spiller in self._konfig["gjeldende spillere"][f"{ant_spillere} spillere"]:
            ...
            self._deltakere.setdefault(spiller,deltaker)
    ...
    def _KI_spillehandterer(self):
        ...
        while True:
            ...
            if self._spiller_i_tur is self._spilleforer:
                continue
            
            ki.utfor_strategi(self)
    ...
    def stokk_kort(self):
        ...
        for i,spkort in enumerate(self._spillekort):
            spkort._prioritet = -i
